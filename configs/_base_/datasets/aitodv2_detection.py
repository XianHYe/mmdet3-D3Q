...
# data_root = '../datasets/AI-TODv2/' # change to your own path
data_root = 'E:/datasets/AI-TODv2/'
...
train_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file='annotations/small_trainval_v2_3.0.json',
...
val_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file='annotations/small_test_v2_2.0.json',
