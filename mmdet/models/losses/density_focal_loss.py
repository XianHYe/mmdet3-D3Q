...
@weighted_loss
def density_focal_loss(pred: Tensor,
...
def density_focal_loss_with_pos_inds(
        pred: Tensor,
        gaussian_target: Tensor,
        pos_inds: Tensor,
        pos_labels: Tensor,
...
class DensityFocalLoss(nn.Module):
    ...
    def forward(self,
        ...
        if pos_inds is not None:
            ...
            loss_reg = self.loss_weight * density_focal_loss_with_pos_inds(
                pred,
                target,
                pos_inds,
                pos_labels,
            ...
            loss_reg = self.loss_weight * density_focal_loss(
                pred,
                target,
                weight,
                alpha=self.alpha,
